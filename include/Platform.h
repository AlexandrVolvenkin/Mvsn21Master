...
// #pragma vector = USART_RX_vect		// Прерывание по завершению приема UART
// static __interrupt void __URXComplete(void);
//
// #pragma vector = USART_UDRE_vect	// Прерывание по пустому регистру данных UDR
// static __interrupt void __UDREmpty(void);
//
// #pragma vector = USART_TX_vect		// Прерывание по завершению передачи UART
